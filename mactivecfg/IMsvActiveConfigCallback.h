...
/**************************************************************************************************//**
* @file
* @brief			MarsTech Active Config Callback Interface
* @details		Contains interface of MarsTech Active Config Callback.
...
#ifndef MARSTECH_IACTIVECONFIG_CALLBACK_H
#define MARSTECH_IACTIVECONFIG_CALLBACK_H
...
/**************************************************************************************************//**
* @brief		MarsTech Active Config Callback Interface.
* @details	Interface for active configuration callback which notifies about data changes
*				in an active config.
* @warning	This callback works only with one instance of active config and it is not cross process.
*				Other processes won't be notified about changes in an active config. Same for more
*				instances of an active config in one process.
******************************************************************************************************/
class IMsvActiveConfigCallback
{
public:
	/**************************************************************************************************//**
	* @brief		Virtual destructor.
	******************************************************************************************************/
	virtual ~IMsvActiveConfigCallback() {}
...
#endif // !MARSTECH_IACTIVECONFIG_CALLBACK_H
